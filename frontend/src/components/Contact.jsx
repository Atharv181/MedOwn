...
const Contact = () => {
  ...
  return (
    <>
        <div className="px-6 py-24 -mt-24 bg-white isolate">
      <div className="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl ">
      
      </div>
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl hover:text-blue-300 underline">Contact Form</h2>
        
        <p className="mt-2 text-lg leading-8 text-gray-600">
          If you have any query you can contact us here using the form.
        </p>
      </div>
